compartment_display_name="vbs_tf_compartment"
vcn_cidr_block = "10.1.0.0/16"
vcn_display_name = "vbs_tf_vcn"
igw_display_name = "vbs_tf_igw"
...
compute_instance_display_name = "vbs_tf_compute_instance"
